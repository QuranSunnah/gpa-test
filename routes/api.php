...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::get('/events/{slug}', [Api\V1\EventsController::class, 'show']);
    Route::get('/gallery', [Api\V1\GalleryController::class, 'index']);
    Route::get('/gallery/{slug}', [Api\V1\GalleryController::class, 'show']);
